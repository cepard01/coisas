export const en = {
  ...
  achievements: {
    ...
    title: "Earn badges by",
    highlight: "playing, not paying.",
    description:
      "Every badge is earned through gameplay — planting, harvesting, discovering, caring. No purchases, no shortcuts, no exclusives.",
    items: [
      { emoji: "🌱", name: "First Seed", desc: "Plant your first seed", earned: true },
      { emoji: "🌻", name: "Sunflower Farmer", desc: "Harvest 10 sunflowers", earned: true },
      { emoji: "🌸", name: "Mutation Discoverer", desc: "Find a Pink Rose", earned: true },
      { emoji: "💧", name: "Dedicated Waterer", desc: "Water 50 times", earned: true },
      { emoji: "☀️", name: "Weather Watcher", desc: "Check weather 30 days", earned: true },
      { emoji: "🧪", name: "Alchemist", desc: "Discover 3 mutations", earned: false },
      { emoji: "🎃", name: "Decorator", desc: "Place a decoration", earned: false },
      ...
      { emoji: "🌧️", name: "Rain Dancer", desc: "Play during 10 storms", earned: false },
      { emoji: "🌙", name: "Night Owl", desc: "Harvest after midnight", earned: false },
      { emoji: "⭐", name: "Century Bloom", desc: "Harvest 100 flowers", earned: false },
    ],
    earnedLabel: "earned",
    lockedLabel: "locked",
  },
