...
export const ptBR: Translation = {
  ...
  achievements: {
    ...
    eyebrow: "Conquistas",
    title: "Ganhe badges",
    highlight: "jogando, não pagando.",
    description:
      "Cada badge é ganha jogando — plantando, colhendo, descobrindo, cuidando. Sem compras, sem atalhos, sem exclusivos.",
    items: [
      { emoji: "🌱", name: "Primeira Semente", desc: "Plante sua primeira semente", earned: true },
      { emoji: "🌻", name: "Fazendeiro de Girassol", desc: "Colha 10 girassóis", earned: true },
      { emoji: "🌸", name: "Descobridor de Mutação", desc: "Encontre uma Rosa Rosa", earned: true },
      { emoji: "💧", name: "Regador Dedicado", desc: "Regue 50 vezes", earned: true },
      { emoji: "☀️", name: "Observador do Clima", desc: "Confira o clima 30 dias", earned: true },
      { emoji: "🧪", name: "Alquimista", desc: "Descubra 3 mutações", earned: false },
      { emoji: "🎃", name: "Decorador", desc: "Coloque uma decoração", earned: false },
      ...
      { emoji: "🌧️", name: "Dançarino da Chuva", desc: "Jogue durante 10 tempestades", earned: false },
      { emoji: "🌙", name: "Coruja Noturna", desc: "Colha após meia-noite", earned: false },
      { emoji: "⭐", name: "Flor Centenária", desc: "Colha 100 flores", earned: false },
    ],
    earnedLabel: "ganha",
  ...
  panel: {
    ...
    dashboard: {
      ...
      synced: "sincronizado",
      tabs: { garden: "Jardim", wallet: "Carteira", missions: "Missões", collection: "Coleção", shop: "Loja", weather: "Clima" },
      alerts: "Alertas",
      ...
      shop: {
        title: "Loja",
        subtitle: "Compre sementes, ferramentas e decorações com Daisies",
        balance: "Saldo",
        buy: "Comprar",
        owned: "Possui",
        categories: { seeds: "Sementes", tools: "Ferramentas", decor: "Decorações", consumables: "Consumíveis" },
        items: [
          { emoji: "🌻", name: "Semente de Girassol", category: "seeds", price: 50, desc: "Cresce em 1 minuto", owned: 3 },
          { emoji: "🌹", name: "Semente de Rosa Vermelha", category: "seeds", price: 100, desc: "Cresce em 2 minutos", owned: 0 },
          { emoji: "🤍", name: "Semente de Rosa Branca", category: "seeds", price: 100, desc: "Cresce em 2 minutos", owned: 0 },
          { emoji: "🥕", name: "Semente de Cenoura", category: "seeds", price: 30, desc: "Cresce em 1 minuto", owned: 5 },
          { emoji: "🚿", name: "Regador", category: "tools", price: 500, desc: "Rega suas plantas", owned: 1 },
          { emoji: "💩", name: "Fertilizante Básico", category: "consumables", price: 50, desc: "Acelera crescimento em 10%", owned: 2 },
          { emoji: "🎃", name: "Espantalho", category: "decor", price: 1500, desc: "Afasta pássaros", owned: 0 },
          { emoji: "👺", name: "Gnomo de Jardim", category: "decor", price: 1000, desc: "Um amuleto de sorte", owned: 0 },
        ],
        notEnough: "Daisies insuficientes",
      },
      weather: {
        title: "Clima",
        subtitle: "Condições atuais e previsão de 5 passos",
        current: {
          label: "Agora mesmo",
          effect: "×1.5 crescimento · ×2.0 evaporação",
          advice: "Plantas crescem mais rápido mas precisam de mais água",
        },
        forecast: "Previsão",
        history: "Histórico recente",
        next: "Próxima mudança",
        nextTime: "em ~2h 34m",
        historyItems: [
          { emoji: "🌧️", name: "Chuvoso", time: "4h atrás" },
          { emoji: "☀️", name: "Ensolarado", time: "8h atrás" },
          { emoji: "🌧️", name: "Chuvoso", time: "12h atrás" },
          { emoji: "⛈️", name: "Tempestade", time: "16h atrás" },
        ],
      },
    },
  },
  ...
  footer: {
    ...
    newsletter: {
      ...
      subtitle: "Atualizações ocasionais sobre novas plantas, eventos e recursos. Sem spam, nunca.",
      placeholder: "seu@email.com",
      button: "Inscrever",
      success: "Inscrito! Entraremos em contato.",
    },
  },
  auth: {
  ...
  changelog: {
    ...
    eyebrow: "Changelog",
    title: "Cada mudança,",
    highlight: "documentada.",
    description:
      "Sem spin de marketing. Notas de versão reais, bugs reais corrigidos, coisas reais ainda quebradas. O histórico completo está no git log.",
    entries: [
      {
        version: "0.4.2", date: "2 semanas atrás", tag: "fixed",
        title: "Recompensas de colheita corrigidas",
        body: "Sementes agora mapeiam corretamente para itens de flor. Antes algumas colheitas falhavam silenciosamente porque IDs crop_* não estavam registrados.",
        details: ["Corrigido mapeamento semente-para-flor para todos os tipos de planta", "Colheita agora concede itens de flor corretamente", "Validação de inventário não rejeita mais colheitas válidas"],
      },
      {
        version: "0.4.1", date: "1 mês atrás", tag: "added",
        title: "Mutação Rosa Rosa",
        body: "Plante Rosa Vermelha + Branca lado a lado. 30% de chance de híbrida rara quando as duas amadurecem.",
        details: ["Nova receita de mutação: rose_pink_mutation", "Detecção de adjacência para dicas de mutação", "Entrada no livro de coleção para Rosa Rosa", "30% de chance de sucesso por colheita"],
      },
      {
        version: "0.4.0", date: "2 meses atrás", tag: "changed",
        title: "Reformulação do sistema de clima",
        body: "Ciclo de 4 horas com previsão de 5 passos. Tempestades agora abrem chances de mutação. Chuva rega o solo de graça.",
        details: ["WeatherManager.init() chamado na inicialização", "Fila de previsão de 5 passos no Redis", "Journal de histórico de clima no MongoDB", "Tempestade abre chances de mutação"],
      },
      {
        version: "0.3.5", date: "3 meses atrás", tag: "added",
        title: "Loja com transações atômicas",
        body: "Compre sementes, ferramentas e decorações. Dedução de moeda e concessão de item acontecem em uma única transação MongoDB.",
        details: ["ShopManager com suporte a transações", "8 itens em 4 categorias", "Verificação de saldo antes da compra", "Atualização atômica de moeda + inventário"],
      },
      {
        version: "0.3.0", date: "4 meses atrás", tag: "changed",
        title: "Arquitetura de viewers UI-first",
        body: "Toda a jogabilidade agora acontece através de painéis Discord Components v2. Comandos são apenas pontos de entrada.",
        details: ["BaseViewer com protocolo customId", "ViewerRegistry para roteamento", "Reconstrução de UI stateless", "Proteção de propriedade em todos os viewers"],
      },
      {
        version: "0.2.0", date: "6 meses atrás", tag: "wip",
        title: "Ciclo principal do jogo",
        body: "Plantar, crescer, colher, ganhar. O ciclo básico funciona de ponta a ponta. Ainda faltam missões e livro de coleção.",
        details: ["GardenService com computação lazy de estado", "Fluxo de plantio com consumo de inventário", "Colheita com recompensas de XP e itens", "Integração de clima no cálculo de crescimento"],
      },
    ],
    tagLabels: { fixed: "Corrigido", added: "Adicionado", changed: "Mudado", wip: "Em progresso" },
  ...
  leaderboard: {
    number: "12",
    eyebrow: "Ranking",
    title: "Top jardineiros",
    highlight: "desta temporada.",
    description:
      "Um ranking amigável — sem competição agressiva. Só um jeito de ver quem tem cuidado bem do jardim.",
    tabs: { level: "Por Nível", collection: "Por Coleção", mutations: "Por Mutações" },
    ...
    privacyNote: "Apenas jogadores que optaram pelo ranking aparecem aqui.",
  },
};
